...
export class GuestService {
  ...
  listar_categorias_publico():Observable<any>{
    let headers = new HttpHeaders().set('Content-Type','application/json');
    return this._http.get(this.url + 'listar_categorias_publico',{headers:headers});
  }

  listar_id_categorias_publico(id:any):Observable<any>{
    let headers = new HttpHeaders().set('Content-Type','application/json');
    return this._http.get(this.url + 'listar_id_categorias_publico/'+id,{headers:headers});
  }

  listar_productos_categoria_publico(filtro: any):Observable<any>{
    let headers = new HttpHeaders().set('Content-Type','application/json');
    return this._http.get(this.url+'listar_productos_categoria_publico/'+filtro,{headers:headers});
  }

  listar_logo_categoria_publico():Observable<any>{
    let headers = new HttpHeaders().set('Content-Type','application/json');
    return this._http.get(this.url+'listar_logo_categoria_publico/',{headers:headers});
  }

  // obtener_logo(img:any):Observable<any>{
  //   let headers = new HttpHeaders().set('Content-Type','application/json');
  //   return this._http.get(this.url+'obtener_logo/'+img,{headers:headers});
  // }
